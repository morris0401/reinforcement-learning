...
Original file is located at
    https://colab.research.google.com/drive/1dMs4GihwTyN158D_kJpugTJJGfNoILgG
"""
...
class Policy(nn.Module):
    ...
    def calculate_loss(self, gamma=0.999):
        ...
        values = torch.stack([action.value for action  in saved_actions], dim=0)[:,0]
        advantages = 0.0  # Initialize advantages
        with torch.no_grad():
